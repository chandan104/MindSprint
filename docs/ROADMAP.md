...
## Phase 1 — Foundation (no gameplay)
...
- Flutter skeleton: teacher login, roster browse (school → class → student),
...
## Phase 2 — Assessment engine + Memory Recall
...
- Events flow: gameplay → Drift → provisional metrics → instant result screen

## Phase 3 — Mathematics Speed + sync hardening
...
## Phase 4 — Canonical metrics + first reports
...
- Admin: session list/detail, student report v1, dashboard overview
  (recently finished · needs review)

## Phase 5 — Session replay + benchmarks
...
## Phase 6 — Content tooling + exports
